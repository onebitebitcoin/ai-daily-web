...
카드뉴스가 글 모음처럼 보인다 — 2026-09-21 btc 발행이 10장 중 5장이 이 경로로 가서
한 편이 통째로 글자판이 됐다. 아래 5.0절 순서를 먼저 다 밟고(4번 키워드 삽화까지),
그래도 쓸 이미지가 없을 때만 `media: null`로 간다.
